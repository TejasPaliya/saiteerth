...
<path d="M17.5 25.7141C18.5194 25.7141 19.3457 24.8878 19.3457 23.8684C19.3457 22.8491 18.5194 22.0227 17.5 22.0227C16.4806 22.0227 15.6543 22.8491 15.6543 23.8684C15.6543 24.8878 16.4806 25.7141 17.5 25.7141Z" fill="#7F050A"/>
    ...
    <div className="font-['Anek_Latin'] font-semibold text-[27px] sm:text-[40px] lg:text-[55px] leading-[100%] text-[#7F050A]">
  Important Notes
</div>

        </div>
<ul className="font-['Anek_Latin'] font-normal text-[16px] leading-[27px] sm:text-[22px] sm:leading-[34px] lg:text-[35px] lg:leading-[53px] mt-8 list-disc list-inside">
...
<path d="M17.5 25.7141C18.5194 25.7141 19.3457 24.8878 19.3457 23.8684C19.3457 22.8491 18.5194 22.0227 17.5 22.0227C16.4806 22.0227 15.6543 22.8491 15.6543 23.8684C15.6543 24.8878 16.4806 25.7141 17.5 25.7141Z" fill="#7F050A"/>
        ...
        <ul className="font-['Anek_Latin'] font-normal text-[16px] leading-[27px] sm:text-[22px] sm:leading-[34px] lg:text-[35px] lg:leading-[53px] mt-8 list-disc list-inside">
          ...
          <li>Food, beverages and shopping not included.</li>
          <li>No refunds once ticket purchased.</li>
          <li>No alcohol or drunk visitors.</li>
          <li>Show times may change based on crowd.</li>
          <li>No photos or videos allowed.</li>
          <li>Full visit takes around 3 hours.</li>
          <li>Baggage storage Rs.50.</li>
          <li>Parking costs extra.</li>
          <li>Smoking prohibited.</li>
        </ul>
      </div>

      <span className="bg-yellow-400 text-[#80050A] my-6 mx-auto font-extrabold py-3 px-10 rounded-full uppercase shadow-sm hover:bg-yellow-500 transition-colors cursor-pointer">
