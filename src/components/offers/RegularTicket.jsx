...
const RegularTicket = () => {
  return (
    <div>
        <div className='font-anek text-[#80050A] font-bold text-[61px] leading-[100%] tracking-[0%] text-center mx-auto'>Regular Tickets Prices</div>
...
aspect-[1.85/1] 
      ...
      ">
        ...
        <div className="text-center mb-6 z-10">
          <h2 className="text-white text-4xl md:text-5xl font-bold tracking-wide drop-shadow-md mb-1">
            Regular Adult
          </h2>
          <p className="text-white/90 text-lg md:text-xl font-light tracking-wide drop-shadow-sm">
            [Height Above 4 6]
          </p>
        </div>
        ...
        <div className="flex gap-6 w-full justify-center px-4 md:px-12 z-10">
          ...
          {/* Price Box 2: Weekends */}
          <PriceBox 
            title="Sat, Sun & Holidays" 
            price="₹599*" 
          />
