...
const OfferHero = () => {
  ...
  <div className="relative w-full h-[80vh] md:h-[100vh] overflow-hidden flex flex-col">
      ...
      <div className="font-['Anek_Latin'] font-extrabold text-white text-center leading-[1.16] text-[28px] sm:text-[36px] md:text-[44px] lg:text-[50px] xl:text-[58px]">Offers & Tickets</div>
