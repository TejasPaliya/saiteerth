...
const AvailNavbar = () => {
  ...
  // No scroll effect needed for AvailNavbar as it's static and always scrolled=true
  ...
  return (
    <div>
      <div className={`w-full p-4 z-50 transition-all duration-300 ${
        ...
        <div className="flex justify-between items-center max-w-[1500px] m-auto w-full md:px-8">
          ...
          <div className="hidden lg:flex justify-between items-center gap-6">
            ...
            <Link href="https://saiteerth.in/book-now?theme=sai-teerth&location_id=5&destination_id=10" className={`rounded-[50px] font-bold text-[16px] border border-[#FEB22A] p-2 px-4 transition-all ${
