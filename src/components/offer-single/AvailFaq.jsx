...
const faqs = [
  {
    question: "Where is Sai Teerth located in Shirdi, and how do I reach it from the Sai Baba Temple?",
    answer: "Sai Teerth is located just 5 minutes from the Sai Baba Temple, behind the Sun-n-Sand Hotel in Shirdi, Maharashtra. You can walk, take an auto, or use Google Maps to easily reach the location. It's a must-visit spot for pilgrims and tourists."
  },
  {
    question: "What attractions are available at Sai Teerth Devotional Theme Park?",
    answer: "Various devotional and cultural attractions, gardens, and entertainment options for visitors of all ages."
  },
  {
    question: "What are the Sai Teerth ticket prices and timings?",
    answer: "Tickets are priced differently for adults, kids, and groups. Timings are usually 9 AM to 6 PM, but check the official site for updates."
  },
  {
    question: "Is Sai Teerth suitable for families, senior citizens, and school groups?",
    answer: "Yes! The park is designed to be family-friendly and accessible for all age groups."
  },
  {
    question: "Are food and facilities available inside Sai Teerth?",
    answer: "Yes, there are multiple food courts, rest areas, and basic amenities for visitors."
  },
];
...
<div className="border-b" style={{
    // If open: Gradient overlay on top, image at bottom
    // If closed: Just the image
    background: isOpen 
  ...
  className={`w-full text-left p-2 max-md:pb-2 flex justify-between items-center transition-colors duration-200 
    font-['Anek_Latin'] 
    ${isOpen 
      ? "text-white font-bold font-['Anek_Latin']  text-[19px] md:text-[21px] lg:text-[26px] leading-tight" 
      : "text-[#DEDEDE] font-semibold text-[19px] font-['Anek_Latin']  leading-[22px] md:text-[22px] lg:text-[26px]"
    }`}
  onClick={onClick}
  >
    {faq.question}
