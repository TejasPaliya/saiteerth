  ...
  return (
    <div className="p-8 mt-6 max-w-[1800px] mx-auto">
      <div className="flex max-lg:justify-center justify-between items-center">
        <div className="text-[#892201] font-bold not-italic text-3xl sm:text-4xl md:text-5xl lg:text-6xl mb-4">
   ...
   onSwiper={(swiper) => (swiperRef.current = swiper)}
    ...
    >
      {[1, 2, 3, 4,5, 6,7 ,8].map((x) => (
        <SwiperSlide key={x}>
          <div className="max-w-[400px] w-full shadow-[-2px_17px_16px_4px_rgba(0,0,0,0.39)] rounded-[20px] p-1">
            <img
              src="/offers.png"
              alt=""
