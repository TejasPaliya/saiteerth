            ...
            {offersList.map((item) => (
              <SwiperSlide key={item.id}>
                <div className="max-w-[400px] mx-auto w-full shadow-[-2px_17px_16px_4px_rgba(0,0,0,0.15)] rounded-[20px] overflow-hidden bg-white mb-10">
                  <img
                    src={"https://strapi.saiteerth.in"+item.card_image?.url }
                    alt={item.name}
                  ...
                  <div className="p-4 bg-white">
                    ...
                    <div className="flex gap-3 mt-5">
                      ...
                      <a href={"/offers/"+item.slug} className="bg-[#FCD503] flex-1 rounded-[12px] py-2 text-center font-semibold text-[#000000] hover:bg-yellow-500 transition-colors">
                        View More
                      </a>
                    </div>
                  </div>
