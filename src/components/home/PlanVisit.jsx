...
const PlanVisit = () => {
  return (
    <div className="bg-[url('/plan-visit.png')] bg-cover bg-center flex flex-col p-6 md:p-12 lg:p-16 items-center w-full">
      ...
      <div className="font-['Anek_Latin'] font-semibold text-[28px] leading-[32px] sm:text-[36px] sm:leading-[40px] md:text-[49px] md:leading-[49px] lg:text-[70px] lg:leading-[76px] text-center text-white mb-2">
        Plan your visit with ease
      </div>

      <div className="font-['Anek_Latin'] font-medium text-[16px] leading-[22px] sm:text-[18px] sm:leading-[24px] md:text-[20px] md:leading-[25px] lg:text-[31px] lg:leading-[31px] text-center text-white max-w-4xl">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mt-8 lg:mt-16 gap-8 md:gap-10 lg:gap-16 w-full">
        ...
        <div className="bg-white rounded-2xl p-6 flex flex-col items-center w-full max-w-[350px] hover:shadow-lg transition-shadow">
          ...
          <div className="font-['Anek_Latin'] font-semibold text-[24px] sm:text-[30px] md:text-[38px] lg:text-[47px] text-center text-[#CD3F0D] mt-2 mb-4">
            Park Timings
          </div>
