...
// Dummy Data for the static version
const DUMMY_FAQS = [
  {
    id: 1,
    question: "What are the benefits of using this service?",
    answer: "Our service provides top-tier efficiency, 24/7 support, and a seamless user experience designed to help you scale your projects faster than ever."
  },
  {
    id: 2,
    question: "How do I get started with the implementation?",
    answer: "Getting started is easy! Simply sign up for an account, follow our quick-start guide, and you'll have your first project running in under 10 minutes."
  },
  {
    id: 3,
    question: "Is there a free trial available for new users?",
    answer: "Yes, we offer a 14-day free trial with full access to all premium features so you can test the waters before committing."
  },
  {
    id: 4,
    question: "Can I cancel my subscription at any time?",
    answer: "Absolutely. You can manage your subscription settings from your dashboard and cancel at any time without any hidden fees."
  }
];
  ...
  return (
    <div className="border-b" style={isOpen ? { background: '#EAEAEA' } : {}}>
      <button
        ...
        font-['Anek_Latin'] 
        ${isOpen 
          ? "text-black font-bold text-[19px] md:text-[21px] lg:text-[26px] leading-tight" 
          : "text-[#484848] font-semibold text-[19px] leading-[22px] md:text-[22px] lg:text-[26px]"
        }`}
        onClick={onClick}
      >
        {faq.question}
        <span className="w-[44px] h-[44px] flex-shrink-0">
          {isOpen ? (
      ...
      {isOpen && (
        <div className="p-2 pb-6 max-md:pt-0 text-[#484848] font-['Anek_Latin'] font-normal text-[15px] md:text-[13px] lg:text-[15px] lg:leading-normal">
          {faq.answer}
        </div>
      )}
    </div>
